...
.placeCombiningChar
	...
	; Move back 1 tile and up 1 tile
    ld bc, -1
    add hl, bc
   
    ; Print the combining character (´~^`)
   ld [hl], a
	...
	pop hl
	jr NextChar
.placeChar;=======================adiciona acentos fim
...
TMCharText::      db "MT@"
TrainerCharText:: db "TREINADOR@"
PCCharText::      db "PC@"
RocketCharText::  db "ROCKET@"
PlacePOKeText::   db "POKè@"
SixDotsCharText:: db "……@"
EnemyText::       db "<is><Op><p.>@"
...
TextCommandSounds::
	...
	db TX_SOUND_CRY_NIDORINA,         NIDORINO ; used in OakSpeech ;hydalt fix'd
