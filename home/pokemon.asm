...
; if the pokemon's HP is 0, print "FNT" FAINTED FDC DESMAIADO
	ld a, "D"
	ld [hli], a
	ld a, "E"
	ld [hli], a
	...
	or b ; is the pokemon's HP zero?
	pop de
	jr nz, PrintStatusConditionNotFaintedEX
; if the pokemon's HP is 0, print "FNT" FAINTED FDC
	ld a, " "
	ld [hli], a
	ld a, "D"
	ld [hli], a
...
PrintStatusConditionNotFainted::
	...
	ret
PrintStatusConditionNotFaintedEX::
	homecall_sf PrintStatusAilmentEX
	ret
