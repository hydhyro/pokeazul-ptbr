...
.oldManBattle
	ld a, "▶"
	ldcoord_a 1, 4 ; place menu cursor in front of first menu entry;hydalt5
	ld c, 80
	call DelayFrames
	xor a
...
.skipMultiplying
	...
	inc d
.noCarry
	hlcoord 2, 4 ; coordinates of first list entry name;hydalt6
...
.printItemPrice
	...
	pop hl
	ld bc, SCREEN_WIDTH + 10 ;hydalt 1 row down and 5 columns right
	add hl, bc
...
.skipCopyingLevel
	pop hl
	ld bc, $0a;posição do nível level dos pokémons na lista do PC;$1c
	add hl, bc
	call PrintLevelFull
	pop af
	ld [wd11e], a
...
.printItemQuantity
	...
	push hl
	ld bc, 14;hydalt ;SCREEN_WIDTH + 8 ; 1 row down and 8 columns right
	add hl, bc
	ld a, "×"
	ld [hli], a
	ld a, [wd11e]
