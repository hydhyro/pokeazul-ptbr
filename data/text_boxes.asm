...
TextBoxCoordTable:
	...
	db MENU_TEMPLATE_07,  4,  2, 19, 12
	db LIST_MENU_BOX,     0,  2, 19, 12;INVENTÁRIO
...
TextBoxTextAndCoordTable:
	...
	text_box_text BATTLE_MENU_TEMPLATE,               2, 12, 19, 17, BattleMenuText,          4, 14
	text_box_text SAFARI_BATTLE_MENU_TEMPLATE,        2, 12, 19, 17, SafariZoneBattleMenuText, 4, 14
	text_box_text SWITCH_STATS_CANCEL_MENU_TEMPLATE, 10, 11, 19, 17, SwitchStatsCancelText,   12, 12
	text_box_text BUY_SELL_QUIT_MENU_TEMPLATE,        0,  0, 9,  6, BuySellQuitText,          2,  1
	text_box_text MONEY_BOX_TEMPLATE,                10,  0, 19,  2, MoneyText,               11,  0
