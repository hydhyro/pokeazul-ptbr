...
; Learnset
	...
	db 35, SWORDS_DANCE
	db 42, AGILITY
	db 50, WING_ATTACK;add from yellow
	db 0
...
; Evolutions
	db 0
; Learnset
	db 24, BIND;from yellow
	db 27, ABSORB;lv from yellow
	db 29, VINE_WHIP;from yellow
	db 32, POISONPOWDER
	db 36, STUN_SPORE
	db 39, SLEEP_POWDER
	db 45, SLAM
...
; Evolutions
	...
	db 0
; Learnset
	db 9, LOW_KICK;hydalt from yellow
	db 15, KARATE_CHOP
	db 21, FURY_SWIPES
	db 27, FOCUS_ENERGY
	db 33, SEISMIC_TOSS
...
; Evolutions
	...
	db 0
; Learnset
	db 11, SUPERSONIC;hydalt yellow
	db 19, CONFUSION;hydalt yellow
	db 24, POISONPOWDER
	db 27, LEECH_LIFE
	db 30, STUN_SPORE
	db 35, PSYBEAM
...
; Evolutions
	db 0
; Learnset
	db 51, FIRE_BLAST;hydalt corrigindo erro
	db 52, LEER
	db 55, AGILITY
	db 60, SKY_ATTACK
	db 0
...
; Evolutions
	...
	db 0
; Learnset
	db 7, HARDEN;hydalt from yellow
	db 0
