...
GanhouGFX:
  ld de, Ganhou ; the graphic data
  ld hl, vChars1 tile $3b ; where in vram it will be placed
  lb bc, BANK(Ganhou), 5 ; number of tiles the graphic takes up horizontally
  jp CopyVideoData

Ganhou: INCBIN "gfx/font/ganhou.2bpp"
GanhouEnd:
