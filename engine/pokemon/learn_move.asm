...
.loop
	push hl
											hlcoord 5, 7			;add borda de texto para o texto WhichMoveToForgetText
											ld b, 3					;add borda de texto para o texto WhichMoveToForgetText
											ld c, 13				;add borda de texto para o texto WhichMoveToForgetText
	...
	ld c, 18
	call TextBoxBorder
						hlcoord 6, 8						;posição da pergunta de qual golpe esquecer
