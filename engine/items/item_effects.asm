...
.chooseMove
	...
	ld [wMoveMenuType], a
										...
										call Loadqualgfx
										hlcoord 3, 6			;add borda de texto para o texto WhichMoveToForgetText
										ld b, 4					;add borda de texto para o texto WhichMoveToForgetText
										ld c, 15				;add borda de texto para o texto WhichMoveToForgetText
										call TextBoxBorder		;add borda de texto para o texto WhichMoveToForgetText
										hlcoord 4, 8			;posição da pergunta de qual golpe esquecer
										ld de, TextoPPUP		;texto de qual golpe esquecer
	...
	jr c, .printWhichTechniqueMessage ; if so, print the raise PP message
										...
										hlcoord 4, 8			;posição da pergunta de qual golpe esquecer
										ld de, TextoRestorePP	;texto de qual golpe esquecer
										call PlaceString
...
.chooseMon
	...
	ld bc, 17;aumenta o tamanho dos golpes de TM de 14 para 17hydalt
...
TextoRestorePP:
	db   "Restaurar os PP"
	next "de <tr1><tr2><tr3> té´cnica?@"
	
TextoPPUP:
	db   "Expandir os PP"
	next "de <tr1><tr2><tr3> té´cnica?@"
	
Loadqualgfx:; Carrega o gráfico TREINADOR para os ingame Trade Trainer's name
    ld de, qualgfx ; the graphic data
    ld hl, vChars1 tile $3b ; where in vram it will be placed
    lb bc, BANK(qualgfx), 3 ; number of tiles the graphic takes up horizontally
    jp CopyVideoData