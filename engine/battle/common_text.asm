PrintBeginningBattleText:
	...
	jp c, .pokemonTower ;;hydalt changed from jr because the gender check
.notPokemonTower
	...
	jr z,  .Femalecontinue				;;
	cp NIDOQUEEN					;;	
	jr z,  .Femalecontinue				;;	by Engezerstorung
	cp CHANSEY						;;
	jr z,  .Femalecontinue				;;	
	cp KANGASKHAN					;;	
	jr z,  .Femalecontinue				;;	
	cp JYNX							;;	
	jr z, .Femalecontinue					;;							
	ld hl, WildMonAppearedText	;;==impressão normal de "Um X_Pokémon selvagem surgiu!
	jr .normalcontinue
.Femalecontinue						;;hydalt == imprime gênero feminino "Uma XXPokémon selvagem surgiu!"
	ld hl, WildFMonAppearedText		;;
...
.isMarowak
	...
	callfar LoadEnemyMonData
	callfar MarowakAnim
	ld hl, WildFMonAppearedText ;hydalt Female pronoum for Marowak
	call PrintText
...
WildMonAppearedText:
	text_far _WildMonAppearedText  ;um
	text_end
	
WildFMonAppearedText:
	text_far _WildFMonAppearedText ;umA
	text_end	
