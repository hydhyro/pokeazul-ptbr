...
CopyrightTextString:
	...
	next $60,$61,$62,$61,$63,$61,$64,$7F,$73,$74,$75,$76,$77,$78,$79,$7A,$7B ; ©'95.'96.'98 GAME FREAK inc. inc.
	next $c4,$c5,$c6,$c7,$c8,$c9,$ca,$7F,$bb,$bc,$bd,$be,$bf,$c0,$c1,$c2,$c3 ;Hydrigths
	db   "@"
...
IF DEF(_RED)
	db $65,$66,$67,$68,$69,$65,$66,$61,$62,$63,$64,"@" ; "Red Version"
ENDC
IF DEF(_BLUE)
	db $7f,$61,$62,$63,$64,$65,$66,$67,$68,"@" ; "Blue Version"
ENDC
