...
; there's a save file
	...
	ld de, ContinueText
	call PlaceString
	call LoadHydRightsgfx
						hlcoord 6, 17 ; posição do acento do Õ
						ld de, HydVersion
						call PlaceString
	jr .next2
.noSaveFile
...
HydVersion:
	...
	db $7f,$bb,$bc,$bd,$be,$bf,$c0,$c1,$c2,$c3, "v1.1"
	db "@"
...
DisplayContinueGameInfo:
	...
	call PlaceString
							;hlcoord 8, 10 ; posição do acento do Í
							;;ld [hl], $e9
...
.loop
  ...
  jr nz, .loop
	...
	ld a, b
	cp 8
	hlcoord 11, 9 ;imprime o nome 1 tile antes se for VERMELHO
	jr nc, .normalydname2					
	hlcoord 12, 9					
...
PrintSaveScreenText:
	...
	ld de, SaveScreenInfoText
	call PlaceString
								;hlcoord 8, 3 ; posição do acento do Í
								;;ld [hl], $e9
...
.loop
  ...
  jr nz, .loop
	...
	ld a, b
	cp 8
	hlcoord 11, 2 ;imprime o nome 1 tile antes se for VERMELHO
	jr nc, .normalydname					
	hlcoord 12, 2
...
.normalydname
	...
	ld c, 30
	jp DelayFrames
								;hlcoord 15, 11 ; posição do acento do Í
								;ld [hl], $7f
...
DisplayOptionMenu:
	...
	call TextBoxBorder
				...
				;hlcoord 3, 2 ; posição do acento do máx
				;;ld [hl], $e9
				;hlcoord 9, 2 ; posição do acento do méd
				;;ld [hl], $e9
				;hlcoord 16, 2 ; posição do acento do mín
				;;ld [hl], $e9
	hlcoord 1, 1
...
TextSpeedOptionText:
	db   "VELOCIDADE<DD><DO><O >TEXTO"
	next " MA´´X.  ME´´DIO  MI´´N.@"

BattleAnimationOptionText:
	db   "ANIMAÇÃO<DD><DE><E >BATALHA"
	next " LIGAR    DESLIGAR@"

BattleStyleOptionText:
	db   "ESTILO DE BATALHA"
	next " TROCAR<PKMN> MANTER<PKMN>@"
	;next " "
	;next "      Tradução: HYD@"
...
LoadHydRightsgfx:; Carrega o gráfico TREINADOR para os ingame Trade Trainer's name
    ld de, HydRightsgfx ; the graphic data
    ld hl, vChars1 tile $3B ; where in vram it will be placed
    lb bc, BANK(HydRightsgfx), 9 ; number of tiles the graphic takes up horizontally
    jp CopyVideoData