...
YourTextString:
	db " QUAL E´´ O SEU NOME?@"

RivalsTextString:
	db " NOME DO SEU RIVAL?@"
...
minusu:
  ld de, minusugfx ; the graphic data
  ld hl, vChars1 tile $5f ; where in vram it will be placed
  lb bc, BANK(minusugfx), 1 ; number of tiles the graphic takes up horizontally
  jp CopyVideoData

minusugfx: INCBIN "gfx/font/minusU.2bpp"
minusugfxEnd: