...
StartMenu_TrainerInfo::
	...
	call RunPaletteCommand
					ld a, [wOnSGB];			linhas para limpar o bug da tela IPS
					and a;			linhas para limpar o bug da tela IPS
					call z, Delay3;			linhas para limpar o bug da tela IPS
	call GBPalNormal
...
DrawTrainerInfo:
	...
	;checa tamanho do nome do jogador ;hydalt
	  ld hl, wPlayerName
  ld b, -1
.loop
  inc b
  ...
  jr nz, .loop
	...
	ld a, b
	cp 8
	hlcoord 7, 1 ;se maior= que 8 imprime 1 tile antes
	jr nc, .normalpn;então pula para o código normal
	hlcoord 8, 1;senão (<=7) imprime no tile normal e procede


.normalpn	;continuação do código normal
	ld de, wPlayerName
	call PlaceString
										hlcoord 11, 0 ; posição do acento do José
										ld [hl], $7a ; tile de background
	hlcoord 7, 4
	ld de, wPlayerMoney
	ld c, $e3
	call PrintBCDNumber
