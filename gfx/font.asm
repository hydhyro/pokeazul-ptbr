...
;gráficos extras
;VELOCIDADEgfx: INCBIN "gfx/font/velocidade.2bpp"
;VELOCIDADEgfxEnd:
TREINADORgfx: INCBIN "gfx/font/treinador.2bpp"
TREINADORgfxEnd:

HydRightsgfx: INCBIN "gfx/splash/hydrights.2bpp"
HydRightsgfxEnd:

AlturaPesogfx: INCBIN "gfx/font/alturapeso.2bpp"
AlturaPesogfxEnd:

qualgfx: INCBIN "gfx/font/qual.2bpp"
qualgfxEnd:
